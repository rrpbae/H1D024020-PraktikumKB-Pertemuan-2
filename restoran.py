...
system.compute()
print(f"Hasil Evaluasi Nilai Restoran: {system.output['nilai']:.2f}")

# Menampilkan grafik (plot) hasil visualisasi sistem fuzzy
nilai.view(sim=system)

# Menahan program agar grafik tidak langsung tertutup
input("Tekan ENTER untuk menutup grafik dan keluar...")